<div class="asistencias index">
	...
	<tr>
		...
		<td><?php echo h($asistencia['Asistencia']['idUsuario']); ?>&nbsp;</td>
		<td><?php echo h($asistencia['Asistencia']['idGrupo']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $asistencia['Asistencia']['id']), null, __('Are you sure you want to delete # %s?', $asistencia['Asistencia']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
